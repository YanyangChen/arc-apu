...
<div class="col-md-12 nopadding">
	        	...
	        	<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
	      		...
	      		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
	      			...
	      			<acf:Bind on="initData"><script>
	 					$(this).acfComboBox("init", ${searchsupplier} );
	 				</script></acf:Bind>
	      			</acf:ComboBox>
	        	</div>
	...
	<acf:Region id="reg_div_list" type="list" title="PAYMENT REQUEST LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="apuf001-search.ajax" readonly="true" autoLoad="false">
...
<!--   <acf:Region id="reg_form" title="PAYMENT REQUEST LIST">-->
	...
	<acf:Region id="reg_mod_main" title="PAYMENT REQUEST MAINTENANCE (CREDITOR)" type="form">
  	 	...
  	 	<!--  	<div class="col-xs-12 form-padding oneline">  for testing, not hidden the column-->
			   		...
			   		<acf:Bind on="change"><script>
   						...
   						if (supplier_code == ""){
	   						...
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/apu/apuf001/apuf001-apu-get-supplier-name.ajax",
								data   : JSON.stringify({
			...
			<div class="col-xs-12 form-padding oneline">  	
				<label class="control-label col-md-2" for="printed_by">Printed by:</label>
		 		<div class="col-md-2">
			   		<acf:TextBox id="printed_by" name="printed_by" readonly="true"  /> 
		 		</div>
     		...
     		<div class="col-xs-12 form-padding oneline">  	
	 			...
	 			<div class="col-md-2">    
      				<acf:DateTimePicker id="cut_off_date" name="cut_off_date" pickDate="true" pickTime="false" displayformat="YYYY/MM/DD" readonly="true" checkMandatory="false"/>
	...
	<acf:Region id="payment_details" title="PAYMENT DETAILS" type="list">			
		<div class="col-md-12">
			<acf:Grid id="grid_paymentdetails" url="apuf001-get-paymentdetails-table.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
			...
			<acf:Column name="programme_no" caption="Prog. No." width="70" editable="true" checkMandatory="true" type="textButton">
							...
							$.ajax({
								...
								success: function(data) {
									if (data != null) {
										...
										$("#grid_paymentdetails").setRowData(input.rowid, {programme_name: '', business_platform: '', department: '', description: ''});
									}
				...
				<acf:Column name="particulars"   caption="Particulars" width="150" editable="true" maxlength="30"></acf:Column>
 				...
 				<acf:Column name="include_in_weekly_reporting"   caption="Print Week" width="30" type="checkBox" editable="true"></acf:Column>
				<acf:Column name="include_in_monthly_reporting"  caption="Print Mth " width="30" type="checkBox" editable="true"></acf:Column>
 				<acf:Column name="description"  caption="Busi. Platform" width="150" readonly="true"></acf:Column>
...
Controller.setOption({
    ...
    getUrl: "apuf001-get-form.ajax",
	saveUrl: "apuf001-save.ajax",
	...
	{
	// $("#total_payment_amount").setValue($("#grid_paymentdetails").pGrid$getTotalOfColumn("payment_amount"));
